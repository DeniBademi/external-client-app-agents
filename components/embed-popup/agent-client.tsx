...
function EmbedFixedAgentClient({ appConfig }: EmbedFixedAgentClientProps) {
  ...
  const popupOpen = true; // always open inline
  ...
  return (
    <RoomContext.Provider value={room}>
      ...
      >
        <div className="bg-bg2 dark:bg-bg1 border-separator1 h-[480px] w-full rounded-[28px] border drop-shadow-md">
          <div className="relative h-full w-full">
            ...
            >
              <PopupView disabled={false} sessionStarted={true} onDisplayError={setCurrentError} />
            </div>
          </div>
        </div>
      </motion.div>
